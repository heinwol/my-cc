...
Main.new = {}
Main.main = function() 
  __haxe_Log.trace("Haxe is great!", _hx_o({__fields__={fileName=true,lineNumber=true,className=true,methodName=true},fileName="src/Main.hx",lineNumber=5,className="Main",methodName="main"}));
end
